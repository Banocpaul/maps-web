    ...
    <header class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        @if (auth()->user()?->hasPermission('records.export'))
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('operational-records.report-builder') }}" class="inline-flex items-center justify-center rounded-xl border border-sky-300 bg-white px-4 py-2.5 text-sm font-semibold text-sky-700 hover:bg-sky-50">Open Report Builder</a>
                <a href="{{ route('operational-records.export', request()->query()) }}" class="inline-flex items-center justify-center rounded-xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800">Export filtered CSV</a>
            </div>
        @else
            <a href="{{ route('operational-records.report-builder') }}" class="inline-flex items-center justify-center rounded-xl border border-sky-300 bg-white px-4 py-2.5 text-sm font-semibold text-sky-700 hover:bg-sky-50">Open Report Builder</a>
        @endif
